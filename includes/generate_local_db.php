...
for ($i = 1; $i <= 1000; $i++) {
    ...
    $products[] = [
        ...
        'fp_tag' => strtolower($category) . ", $adj",
        'fp_img' => "https://picsum.photos/800/800?random=$i",
        'fp_gallery' => "https://picsum.photos/800/800?random=" . ($i + 1000) . ",https://picsum.photos/800/800?random=" . ($i + 2000),
